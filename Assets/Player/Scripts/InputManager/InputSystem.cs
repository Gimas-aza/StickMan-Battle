    ...
    public struct PlayerOneActions
    {
        ...
        public void SetCallbacks(IPlayerOneActions instance)
        {
            if (m_Wrapper.m_PlayerOneActionsCallbackInterface != null)
            {
                ...
                @Jerk.started -= m_Wrapper.m_PlayerOneActionsCallbackInterface.OnJerk;
                @Jerk.performed -= m_Wrapper.m_PlayerOneActionsCallbackInterface.OnJerk;
                @Jerk.canceled -= m_Wrapper.m_PlayerOneActionsCallbackInterface.OnJerk;
                @Shoot.started -= m_Wrapper.m_PlayerOneActionsCallbackInterface.OnShoot;
                @Shoot.performed -= m_Wrapper.m_PlayerOneActionsCallbackInterface.OnShoot;
                @Shoot.canceled -= m_Wrapper.m_PlayerOneActionsCallbackInterface.OnShoot;
            }
    ...
    public struct PlayerTwoActions
    {
        ...
        public void SetCallbacks(IPlayerTwoActions instance)
        {
            if (m_Wrapper.m_PlayerTwoActionsCallbackInterface != null)
            {
                ...
                @Jerk.started -= m_Wrapper.m_PlayerTwoActionsCallbackInterface.OnJerk;
                @Jerk.performed -= m_Wrapper.m_PlayerTwoActionsCallbackInterface.OnJerk;
                @Jerk.canceled -= m_Wrapper.m_PlayerTwoActionsCallbackInterface.OnJerk;
                @Shoot.started -= m_Wrapper.m_PlayerTwoActionsCallbackInterface.OnShoot;
                @Shoot.performed -= m_Wrapper.m_PlayerTwoActionsCallbackInterface.OnShoot;
                @Shoot.canceled -= m_Wrapper.m_PlayerTwoActionsCallbackInterface.OnShoot;
            }
